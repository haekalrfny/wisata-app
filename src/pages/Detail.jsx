...
const Detail = () => {
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center">
      <div className="w-full h-[15%] flex items-end py-4 justify-center">
        <div className="w-[700px] flex gap-10 items-center">
          <SlArrowLeft className="text-3xl" />
          <h2 className="text-2xl font-bold leading-[39px] text-black">
            Wisata Air Terjun
          </h2>
        </div>
      </div>
      ...
      <div className="w-full h-[25%] flex flex-col items-center">
        <div className="w-[700px] h-full flex flex-col gap-2 py-4">
